    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <div className="flex flex-1 max-w-screen-2xl mx-auto w-full">
        ...
        <main className="flex-1 min-w-0 p-4 md:p-6 lg:p-8">
          ...
          {/* 하단 푸터 */}
          <footer className="mt-12 pt-6 border-t border-gray-200 text-center text-xs text-gray-400 space-y-1">
            <p>Business AI Class Studio — 생성형 AI 기반 경영학 수업 실습 플랫폼</p>
            <p>⚠️ AI 생성 결과물은 교수자 검토 후 수업에 활용하세요. 학생 개인정보는 서버에 저장되지 않습니다.</p>
            <p>저작권·표절·AI 윤리를 준수하여 사용해 주세요. © 2025 Business AI Class Studio</p>
            {/* 향후 API 연동 가능 */}
          </footer>
        </main>
      </div>
